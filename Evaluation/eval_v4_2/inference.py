...
from afib_detector_v4_2 import AfibDetector


class AfibInference():
    def __init__(self):
        self.model_path = "./afib_detector_v4_2_2-20250124_203052-6.pt"
        self.fs = 125 # Sampling frequency
        self.inference_window = 10 * self.fs
        self.stride = 10 * self.fs
